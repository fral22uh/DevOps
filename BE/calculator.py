...
if (args.add):
    ...
    print(f'{args.add[0]}+{args.add[1]}={result} Here is an added string')
elif (args.subtract):
    result = CalculatorHelper().subtract(args.subtract[0], args.subtract[1])
    print(f'{args.subtract[0]}-{args.subtract[1]}={result} Here is an added string')
elif (args.multiply):
    result = CalculatorHelper().multiply(args.multiply[0], args.multiply[1])
    print(f'{args.multiply[0]}*{args.multiply[1]}={result} Here is an added string')
elif (args.divide):
    result = CalculatorHelper().divide(args.divide[0], args.divide[1])
    print(f'{args.divide[0]}/{args.divide[1]}={result} Here is an added string')
elif (args.rest):
